...
| `attributes_collapsible`   | `boolean`                  | `false`   | Start current weather attributes collapsed. Click, tap, or press Enter or Space on the current conditions row to expand or collapse them.                                                                                                                                                                                                                                                                                                                                                                                                                  |
...
To keep every available attribute accessible without making the card permanently tall:
